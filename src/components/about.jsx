                ...
                <div className='flex flex-col w-full h-full'>
                    ...
                    <div className='w-full'>
                        <section className='p-2 mb-2 border-b border-seaGreen'>
                            ...
                            <div className='flex flex-row flex-wrap text-softCream text-xs font-bold'>
                                <p className='hover:animate-bounce mr-2 border-2 border-seaGreen rounded-full p-1 bg-green-600 shadow-md'>JavaScript</p>
                                <p className='hover:animate-bounce mr-2 border-2 border-seaGreen rounded-full p-1 bg-green-600 shadow-md'>HTML</p>
                                <p className='hover:animate-bounce mr-2 border-2 border-seaGreen rounded-full p-1 bg-green-600 shadow-md'>TypeScript</p>
                                <p className='hover:animate-bounce mr-2 border-2 border-seaGreen rounded-full p-1 bg-green-600 shadow-md'>Python</p>
                            </div>
                        </section>
                        ...
                        <section className='p-2 mb-2 w-full border-b border-seaGreen'>
                            ...
                            <div className='flex flex-row flex-wrap text-softCream text-xs  font-bold'>
                                <p className='hover:animate-bounce mr-2 border-2 border-seaGreen rounded-full p-1 bg-green-600 shadow-md'>React</p>
                                <p className='hover:animate-bounce mr-2 border-2 border-seaGreen rounded-full p-1 bg-green-600 shadow-md'>React Native</p>
                                <p className='hover:animate-bounce mr-2 border-2 border-seaGreen rounded-full p-1 bg-green-600 shadow-md'>Vite</p>
                                <p className='hover:animate-bounce mr-2 border-2 border-seaGreen rounded-full p-1 bg-green-600 shadow-md'>TailwindCSS</p>
                                <p className='hover:animate-bounce mr-2 border-2 border-seaGreen rounded-full p-1 bg-green-600 shadow-md'>Expo GO</p>
                            </div>
                        </section>
